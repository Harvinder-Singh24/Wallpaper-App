...
List<CategorieModel> getCategories() {
  ...
  //
  categorieModel.imgUrl =
      "https://images.pexels.com/photos/421129/pexels-photo-421129.jpeg?cs=srgb&dl=pexels-nicolas-postiglioni-421129.jpg&fm=jpg";
  categorieModel.categorieName = "Neon";
  categories.add(categorieModel);
  categorieModel = CategorieModel();
  ...
  categorieModel.categorieName = "Cyberpunk";
  categories.add(categorieModel);
  categorieModel = CategorieModel();
